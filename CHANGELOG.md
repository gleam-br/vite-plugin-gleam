...
### Changed
- Merge pull request #7 from gleam-br/issue/6/upgrade_package_toml by @salespaulo in [#7](https://github.com/gleam-br/vite-plugin-gleam/pull/7)
- Update changelog by @github-actions[bot]

### Fixed
- Fix(toml): Upgrade toml package, remove high vulnerabilities by @salespaulo
